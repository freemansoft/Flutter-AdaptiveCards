...
- Files under test are located in packages/flutter_adaptive_cards/lib/src/hostconfig
Test files are located in packages/flutter_adaptive_cards/test/hostconfig
