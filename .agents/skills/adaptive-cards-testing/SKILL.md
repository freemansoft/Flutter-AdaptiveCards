...
- **Element overlays**: `test/elements/text_block_overlay_test.dart`, `badge_overlay_test.dart`, `image_overlay_test.dart`, `media_overlay_test.dart`, `rating_overlay_test.dart`; `test/containers/fact_set_overlay_test.dart`.
