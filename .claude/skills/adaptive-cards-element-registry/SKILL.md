...
What overlay behavior is tested vs. still a gap — the notifier/widget coverage
matrix, cross-cutting concerns, and the checklist for adding tests to a new
overlay field — lives in
[`references/overlay-test-coverage.md`](references/overlay-test-coverage.md).
