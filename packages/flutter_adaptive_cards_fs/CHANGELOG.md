...
- docs: add missing `///` on public default constructors reported by pana (`AdaptiveCardContentProvider`, `AdaptiveCardsCanvasState`, `RawAdaptiveCardState`, `AdaptiveTappableState`, `FadeAnimationState`, `FullCircleClipper`, `AdaptiveUriValidationResult`, `ElementOverlayExtension`).
