...
```yml
dependencies:
  flutter_adaptive_cards_fs: ^0.1.2
```
...
See also the list of [contributors](https://github.com/neohelden/flutter_adaptive_cards_fs/contributors) who participated in this project.
