...
void main() {
  testWidgets('Golden Badge', (tester) async {
    ...
    final Widget sample = getV16SampleForGoldenTest(key, 'badge');
  ...
  testWidgets('Golden Rating', (tester) async {
    configureTestView();
    const ValueKey key = ValueKey('paint');
    final Widget sample = getV16SampleForGoldenTest(key, 'rating');
    await tester.pumpWidget(sample);
    await tester.pumpAndSettle();
  ...
  testWidgets('Golden Carousel', (tester) async {
    configureTestView();
    const ValueKey key = ValueKey('paint');
    final Widget sample = getV16SampleForGoldenTest(key, 'carousel');
    await tester.pumpWidget(sample);
    await tester.pumpAndSettle();
  ...
  testWidgets('Golden Accordion', (tester) async {
    configureTestView();
    const ValueKey key = ValueKey('paint');
    final Widget sample = getV16SampleForGoldenTest(key, 'accordion');
    await tester.pumpWidget(sample);
    await tester.pumpAndSettle();
  ...
  testWidgets('Golden CodeBlock', (tester) async {
    configureTestView();
    const ValueKey key = ValueKey('paint');
    final Widget sample = getV16SampleForGoldenTest(key, 'code_block');
    await tester.pumpWidget(sample);
    await tester.pumpAndSettle();
  ...
  testWidgets('Golden ProgressBar', (tester) async {
    configureTestView();
    const ValueKey key = ValueKey('paint');
    final Widget sample = getV16SampleForGoldenTest(key, 'progress_bar');
    await tester.pumpWidget(sample);
    await tester.pumpAndSettle();
  ...
  testWidgets('Golden Popover', (tester) async {
    configureTestView();
    const ValueKey key = ValueKey('paint');
    final Widget sample = getV16SampleForGoldenTest(key, 'popover');
    await tester.pumpWidget(sample);
    await tester.pumpAndSettle();
