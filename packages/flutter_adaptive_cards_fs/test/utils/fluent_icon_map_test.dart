...
void main() {
  group('resolveFluentIcon — newly added canonical names', () {
    ...
    test(
      'each sample name resolves to a non-fallback icon (filled & regular)',
      () {
  ...
  group('resolveFluentIcon — aliases', () {
    ...
    test(
      'each alias resolves to the same filled icon as its canonical name',
      () {
  ...
  test(
    'catalog has >= 150 keys and every entry has a non-null filled icon',
    () {
