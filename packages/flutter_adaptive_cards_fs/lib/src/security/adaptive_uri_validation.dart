...
/// fetched.
sealed class const AdaptiveUriValidationResult() {
...
class const AdaptiveUriAllowed(
  /// The parsed URI that passed validation.
  final Uri uri,
) extends AdaptiveUriValidationResult {
...
class const AdaptiveUriPolicyException(
  /// Safe-to-log explanation of the rejection.
  final String reason,
