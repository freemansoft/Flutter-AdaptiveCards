...
```yml
dependencies:
  flutter_adaptive_cards_plus: ^0.1.2
```
...
```sh
flutter test packages/flutter_adaptive_cards_plus --exclude-tags=golden
```
...
See also the list of [contributors](https://github.com/neohelden/flutter_adaptive_cards_plus/contributors) who participated in this project.
