...
| 8   | Ollama's prompt cache reused a shared system prompt across conversations on one model and not on the other | `article-8-prompt-cache-*`        | n/a                                                                                           | Not published. Split from 5 on 2026-09-18; review pass, restructured into four findings, two mermaid visuals 2026-09-20. Second review pass 2026-09-21: claim corrections, the retry confound named, restructured and retitled |
