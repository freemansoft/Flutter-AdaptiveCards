...
| 4   | The Ollama tool channel fixed malformed JSON and still lost on half the models         | `article-4-tool-channel-*`        | Not published. **Being rewritten** — its measurement was confounded, see below                       |
