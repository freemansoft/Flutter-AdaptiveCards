...
| 8   | One of two models reused Ollama's prompt cache across conversations                       | `article-8-prompt-cache-*`        | n/a                                                                                           | Not published. Split from 5 on 2026-09-18; review pass, restructured into four findings, two mermaid visuals 2026-09-20. Second review pass 2026-09-21: claim corrections, the retry confound named, restructured, retitled twice, and the bar chart cut as unreadable, leaving the sequence diagram as its visual |
