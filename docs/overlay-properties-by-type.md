...
| `revealPasswordEnabled`                    | `revealPasswordEnabled`    | `Input.Text` password fields only; **preserved on reset** (see [Reset semantics](reactive-riverpod.md#reset-semantics)) |
...
| ---------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| **`Input.Text`**, **`Input.Number`**, **`Input.Date`**, **`Input.Time`**, **`Input.Toggle`**, **`Input.Rating`** | **`Input.Text` only:** `revealPasswordEnabled` (bool overlay; controls eye-icon reveal toggle on `style: "password"` fields; **preserved on reset** unlike value/validation overlays) | `setInputError`, `initInput`, `setRevealPasswordEnabled`, `clearRevealPasswordEnabled`             | `test/inputs/{text,number,date,time,toggle,rating_input}_overlay_test.dart` |
