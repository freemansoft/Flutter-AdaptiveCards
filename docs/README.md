...
Explains how LLM agents are configured for this repo: `AGENTS.md`, the two-layer `.claude/skills/` model (mirrored to `.agents/skills/` for other agents), vendored skill sources ([dart-lang/skills](https://github.com/dart-lang/skills), [flutter/skills](https://github.com/flutter/skills)), the [Superpowers](https://github.com/obra/superpowers) Claude Code plugin, and how agents load skills. Install / update commands: [ai-agent-skills-install.md](./ai-agent-skills-install.md).
