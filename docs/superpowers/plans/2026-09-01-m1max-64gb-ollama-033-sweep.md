...
- **Do not edit the shape-coverage table.** It is generated by `sync_shape_table.dart` from the 0.32.14 archive and verified by `check_results.dart`. This plan adds a configuration; it does not restate the canonical shape measurement.
  _superseded 2026-09-02 — the table now derives from the 0.33.2 runs by user decision, with `granite4.1:3b`'s row flagged cascade-damaged; see the ledger (`.superpowers/sdd/2026-09-01-m1max-64gb-ollama-033-sweep/FIGURES.md`, "CORRECTION 2026-09-02")._
