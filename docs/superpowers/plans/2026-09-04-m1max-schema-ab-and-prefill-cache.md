...
- Create: `adaptive_chat_server_dart/tool/model_probes/results-m1max-64gb-ollama0332/qwen3.6_27b-coding-nvfp4/shape_ab-seeded-format-schema.json`
...
fvm dart run tool/model_probes/shape_ab.dart \
  ...
  --samples 3 \
  --json tool/model_probes/results-m1max-64gb-ollama0332/qwen3.6_27b-coding-nvfp4/shape_ab-seeded-format-schema.json
```
...
for name, path in [('none','/tmp/shape_ab-format-none.json'),
                   ('schema','tool/model_probes/results-m1max-64gb-ollama0332/qwen3.6_27b-coding-nvfp4/shape_ab-seeded-format-schema.json')]:
...
```bash
git add tool/model_probes/results-m1max-64gb-ollama0332/qwen3.6_27b-coding-nvfp4/shape_ab-seeded-format-schema.json
